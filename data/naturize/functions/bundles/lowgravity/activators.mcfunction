...
# Activation
execute if block ~ ~ ~ minecraft:iron_trapdoor if block ~ ~-1 ~ minecraft:orange_concrete as @s[scores={O_LG_Targeted=0}] run playsound minecraft:block.beacon.activate player @s ~ ~ ~ 1 2 0.5
...
# Unactivation
execute if block ~ ~ ~ minecraft:iron_trapdoor if block ~ ~-1 ~ minecraft:gray_concrete as @s[scores={O_LG_Targeted=1}] run playsound minecraft:block.beacon.deactivate player @s ~ ~ ~ 0.9 2 0.5
