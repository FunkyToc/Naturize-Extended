...
effect give @e[type=!player,type=!item,nbt={OnGround:0b},distance=..32] minecraft:slow_falling 1 0 true
...
execute as @s[tag=MoonJump,scores={AirTime=60}] run effect give @s minecraft:levitation 2 0 true
