...
execute as @a[tag=Naturized,scores={O_LG_Activators=1}] at @s if score LowGravityOption O_LG_Activators matches 1 run function naturize:bundles/lowgravity/activators
