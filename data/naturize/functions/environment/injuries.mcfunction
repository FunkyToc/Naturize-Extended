...
# Health points
execute as @e[scores={Health=..4,trigger_10s=1}] at @s run effect give @s minecraft:slowness 11 0 true

# Food points
execute as @e[scores={Food=..10,trigger_10s=1}] at @s run effect give @s minecraft:weakness 11 0 true
execute as @e[scores={Food=..4,trigger_10s=1}] at @s run effect give @s minecraft:weakness 11 1 true
