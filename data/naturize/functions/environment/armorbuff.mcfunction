...
execute as @e[tag=ChainmailAmorSet,scores={trigger_30s=1}] at @s run effect give @s minecraft:regeneration 3 0 true
...
execute as @e[tag=DiamondAmorSet,scores={trigger_60s=1}] at @s run effect give @s minecraft:hunger 1 30 true
execute as @e[tag=DiamondAmorSet,scores={trigger_60s=1}] at @s run effect give @s minecraft:absorption 61 0 true
