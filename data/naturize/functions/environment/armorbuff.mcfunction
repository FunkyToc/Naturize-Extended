...
execute as @e[tag=LeatherAmorSet,scores={trigger_1s=1,WalkDistance=0,SprintDistance=0}] at @s run particle minecraft:end_rod ~ ~1 ~ 0.3 0.4 0.3 0.01 2 normal
...
execute as @e[tag=GoldAmorSet,scores={trigger_1s=1,WalkDistance=0,SprintDistance=0}] at @s run particle minecraft:end_rod ~ ~1 ~ 0.3 0.4 0.3 0.01 2 normal
...
execute as @e[tag=ChainmailAmorSet,scores={trigger_1s=1,WalkDistance=0,SprintDistance=0}] at @s run particle minecraft:end_rod ~ ~1 ~ 0.3 0.4 0.3 0.01 2 normal
...
execute as @e[tag=IronAmorSet,scores={trigger_1s=1,WalkDistance=0,SprintDistance=0}] at @s run particle minecraft:end_rod ~ ~1 ~ 0.3 0.4 0.3 0.01 2 normal
...
execute as @e[tag=DiamondAmorSet,scores={trigger_1s=1,WalkDistance=0,SprintDistance=0}] at @s run particle minecraft:end_rod ~ ~1 ~ 0.3 0.4 0.3 0.01 2 normal
