...
execute as @e[tag=TorchMainhand,scores={DmgDealt=1..,random1=25..75}] at @s run tag @e[distance=..6,nbt={HurtTime:10s}] add burnMedium
...
execute as @e[tag=TorchOffhand,scores={DmgDealt=1..,random1=25..50}] at @s run tag @e[distance=..6,nbt={HurtTime:10s}] add burnSmall
...
execute as @e[tag=ShovelMainhand,scores={DmgDealt=1..55,random1=25..50}] at @s if entity @e[distance=..7,nbt={HurtTime:10s}] run tag @e[distance=..7,nbt={HurtTime:10s}] add stunMedium
