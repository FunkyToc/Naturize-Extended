...
execute as @e[type=chicken,nbt={HurtTime:10s}] at @s run effect give @s minecraft:resistance 10 0 true
execute as @e[type=chicken,nbt={HurtTime:10s}] at @s run effect give @s minecraft:speed 10 3 true
execute as @e[type=chicken,nbt={HurtTime:10s}] at @s run effect give @s minecraft:jump_boost 3 3 true

# Fury
execute as @e[type=chicken] at @s if entity @a[distance=..8,scores={DmgDealt=1..}] run tag @e[type=chicken,distance=..5,nbt={Age:0}] add entityFury
