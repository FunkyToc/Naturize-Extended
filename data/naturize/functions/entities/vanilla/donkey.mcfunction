...
execute as @e[type=donkey,nbt={HurtTime:10s}] at @s run effect give @s minecraft:resistance 10 0 true
execute as @e[type=donkey,nbt={HurtTime:10s}] at @s run effect give @s minecraft:speed 10 1 true
