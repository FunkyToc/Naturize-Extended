...
execute as @e[tag=sheepConcerto,limit=1] at @s if entity @a[scores={trigger_2s=1,random1=25..75},distance=..20] run playsound entity.sheep.ambient neutral @a[distance=..30] ~ ~ ~ 1 1
execute as @e[tag=sheepConcerto,limit=1] at @s if entity @a[scores={trigger_3s=1,random1=50..99},distance=..20] run playsound entity.sheep.ambient neutral @a[distance=..30] ~ ~ ~ 1 1
execute as @e[tag=sheepConcerto,limit=2] at @s if entity @a[scores={trigger_4s=1,random1=25..75},distance=..20] run playsound entity.sheep.death neutral @a[distance=..30] ~ ~ ~ 1 1
execute as @e[tag=sheepConcerto,limit=3] at @s if entity @a[scores={trigger_5s=1,random1=30..70},distance=..20] run playsound entity.sheep.hurt neutral @a[distance=..30] ~ ~ ~ 1 1
