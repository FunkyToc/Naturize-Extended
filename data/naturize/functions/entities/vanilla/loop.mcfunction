# naturize:entities/vanilla/loop
#
# Require all loops in entities/vanilla/
#


execute if score NaturizeOption Opt_EntBoatkill matches 1 run function naturize:entities/vanilla/boat
