...
# New player detected
execute if score Option Opt_Enable matches 1 if score Option Opt_Newplayer matches 1 if entity @a[tag=!Naturized] as @a[tag=!Naturized] at @s run function naturize:config/newplayer
...
execute if score Option Opt_Enable matches 1 run function naturize:environment/loop
