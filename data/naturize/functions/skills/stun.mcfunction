...
execute as @e[tag=stunSmall] as @s at @s run effect give @s minecraft:weakness 2 0 true
...
execute as @e[tag=stunSmall] as @s at @s run effect give @s minecraft:weakness 3 0 true
