...
# Small stun
execute as @e[tag=stunSmall] as @s at @s run effect give @s minecraft:slowness 2 2 true
...
# Medium stun
execute as @e[tag=stunMedium] as @s at @s run effect give @s minecraft:slowness 3 3 true
